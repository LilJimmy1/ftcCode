...
public class FieldCentric extends LinearOpMode {
    ...
    public void runOpMode() {
        DcMotorSimple leftFront = hardwareMap.get(DcMotorSimple.class, "motorLF");
        DcMotorSimple leftBack = hardwareMap.get(DcMotorSimple.class, "motorRF");
        DcMotorSimple rightFront = hardwareMap.get(DcMotorSimple.class, "motorLR");
        DcMotorSimple rightBack = hardwareMap.get(DcMotorSimple.class, "motorRR");
